...
public class TableList {
    ...
    void addRow(String iterasyon1, List<String> head_A, List<String> head_B, List<String> head_C, List<String> head_D, List<String> head_E, List<String> head_F, List<String> head_G, List<String> head_H, List<String> head_J) {
